...
import com.bytedace.doubaoapp.platform.rememberImagePicker
...
fun ChatScreen(
    ...
    val app = DoubaoApp.from(LocalContext.current)
    val viewModel: ChatViewModel = viewModel(factory = ChatViewModelFactory(app.appServices))
    ...
    val pickImages = rememberImagePicker(onImagesPicked = viewModel::onImageSelected)
